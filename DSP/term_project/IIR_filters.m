...
n = 6;  
%cutoff freq.
Wn1 = 500/750; % cutoff frequency for lpf and hpf
Wn2 = [500 560]/750;% cutoff frequency for bpf and bsf
%filtertype
...
title('Magnitude Response(dB) and Phase Response of IIR High Pass Filter')
legend('Magnitude','Phase')
fvtool(sos2,'freq')% ploting low pass filter
title('Magnitude Response(dB) and Phase Response of IIR Low Pass Filter')
legend('Magnitude','Phase')
fvtool(sos3,'freq') % ploting band pass filter
title('Magnitude Response(dB) and Phase Response of IIR Band-Pass Filter')
legend('Magnitude','Phase')
fvtool(sos4,'freq')% ploting band stop filter
title('Magnitude Response(dB) and Phase Response of IIR Band-Stop Filter')
legend('Magnitude','Phase')